...
import balancerVaultAbi from 'config/abi/balancerVault.json'
...
export const getBalancerVaultContract = (signer?: Signer | Provider) => {
  return getContract(balancerVaultAbi, getBalancerVaultAddress(), signer) as BalancerVault
}
