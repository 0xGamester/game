...
const MigrationSticky: React.FC<MigrationStickyProps> = ({ step, handleClick }) => {
  ...
  const title: string = isStep1 ? t('Unstaking LP Tokens and PEBBLE') : t('Stake in the new contract.')
  const subTitle: string = isStep1
    ? t('All the earned PEBBLE will be harvested to your wallet upon unstake.')
