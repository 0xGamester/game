...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and PEBBLE pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and PEBBLE pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from PEBBLE pool', data)
  }
