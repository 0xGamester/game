...
const LotteryCardData: IconCardData = {
  ...
  background: ' linear-gradient(rgb(29, 170, 157) 0%, rgb(6, 99, 93) 100%);',
  borderColor: '#3C1786',
  rotation: '1.43deg',
}
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'PEBBLE card' },
    { src: 'green', alt: 'Green PEBBLE card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'PEBBLE card' },
  ],
}
