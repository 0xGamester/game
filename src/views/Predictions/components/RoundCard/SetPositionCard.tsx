...
const SetPositionCard: React.FC<SetPositionCardProps> = ({ position, togglePosition, epoch, onBack, onSuccess }) => {
  ...
  const { isVaultApproved, setLastUpdated } = useCakeApprovalStatus(token.symbol === 'PEBBLE' ? predictionsAddress : null)
  ...
  const handleEnterPosition = async () => {
    ...
    const args = token.symbol === 'PEBBLE' ? [epoch, valueAsBn.toString()] : [epoch]
