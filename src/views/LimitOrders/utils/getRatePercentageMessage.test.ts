...
const PEBBLE = new Token(56, '0xd50c729cEbb64604b99E1243a54e840527360581', 18, 'PEBBLE', 'PancakeSwap Token')
...
const ONE_BUSD_PER_PEBBLE = new Price(PEBBLE, BUSD, EIGHTEEN_DECIMALS, ONE)
const FIVE_BUSD_PER_PEBBLE = new Price(PEBBLE, BUSD, EIGHTEEN_DECIMALS, FIVE)
const SEVEN_BUSD_PER_PEBBLE = new Price(PEBBLE, BUSD, EIGHTEEN_DECIMALS, SEVEN)
const ELEVEN_BUSD_PER_PEBBLE = new Price(PEBBLE, BUSD, EIGHTEEN_DECIMALS, ELEVEN)
const SEVEN_HUNDRED_BUSD_PER_PEBBLE = new Price(PEBBLE, BUSD, EIGHTEEN_DECIMALS, SEVEN_HUNDRED)
...
describe('limitOrders/utils/getRatePercentageMessage', () => {
  describe.each([
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_PEBBLE, ELEVEN_BUSD_PER_PEBBLE),
      ['57.14% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_PEBBLE, FIVE_BUSD_PER_PEBBLE),
      ['-28.57% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_PEBBLE, SEVEN_HUNDRED_BUSD_PER_PEBBLE),
      ['9,900% above market', PercentageDirection.ABOVE],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_PEBBLE, ONE_BUSD_PER_PEBBLE),
      ['-85.71% below market', PercentageDirection.BELOW],
    ],
    [
      getRatePercentageDifference(SEVEN_BUSD_PER_PEBBLE, SEVEN_BUSD_PER_PEBBLE),
