...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [new TokenAmount(PEBBLE, ONE), new TokenAmount(BUSD, ONE), '1'],
    [new TokenAmount(PEBBLE, FIVE), new TokenAmount(BUSD, FIVE), '1'],
    [new TokenAmount(PEBBLE, ONE), new TokenAmount(BUSD, FIVE), '5'],
    [new TokenAmount(PEBBLE, FIVE), new TokenAmount(BUSD, ONE), '0.2'],
    ...
    [new TokenAmount(PEBBLE, ZERO), new TokenAmount(BUSD, ONE), undefined],
    [new TokenAmount(PEBBLE, ONE), new TokenAmount(BUSD, ZERO), undefined],
