...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold PEBBLE'),
      bodyText: [t('Each NFT costs PEBBLE to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://pancakeswap.finance/swap?outputCurrency=0xd50c729cEbb64604b99E1243a54e840527360581"
            target="_blank"
            width="100%"
          >
            {t('Buy PEBBLE')}
