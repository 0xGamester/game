        ...
        <Flex flexDirection="column">
          <Box px="16px">
            ...
            <Flex mb="8px" justifyContent="space-between">
              ...
              <Text font-size="14px">{formatBigNumber(pricePerTicket, 0)} PEBBLE</Text>
            </Flex>
            <Flex mb="8px" justifyContent="space-between">
              <Text font-size="14px" color="textSubtle">
                {t('Your PEBBLE Balance')}
              </Text>
              <Text font-size="14px" color={isCakeBalanceInsufficient ? 'failure' : 'text'}>
                {formatBigNumber(cakeBalance, 3)} PEBBLE
              </Text>
            </Flex>
            <Flex
              mb="8px"
            ...
            <Flex mb="25px" justifyContent="space-between">
              ...
              <Text font-size="14px" bold>
                {formatBigNumber(totalCost, 0)} PEBBLE
              </Text>
            </Flex>
          </Box>
          <Flex
