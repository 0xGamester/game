...
const PoolCard: React.FC<{ pool: DeserializedPool; account: string }> = ({ pool, account }) => {
  ...
  const isCakePool = earningToken.symbol === 'PEBBLE' && stakingToken.symbol === 'PEBBLE'
    ...
    >
      <PoolCardHeader isStaking={accountHasStakedBalance} isFinished={isFinished && sousId !== 0}>
        <PoolCardHeaderTitle
          ...
          subTitle={isCakePool ? t('Earn PEBBLE, stake PEBBLE') : t('Stake %symbol%', { symbol: stakingToken.symbol })}
        />
